...
# Parsing + Configuration Script – SIMPLEST - Rev. A

This **Parsing + Configuration** script is designed for the **SIMPLEST** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – SIMPLEST Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **SIMPLEST** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
